...
class _BotCommands:
    def __init__(self):
        ...
        self.LeechSetCommand = f'nleechset{CMD_INDEX}'
        self.SetThumbCommand = f'setthumb{CMD_INDEX}'
        self.LeechCommand = f'nleech{CMD_INDEX}'
        self.UnzipLeechCommand = f'nunzipleech{CMD_INDEX}'
        self.ZipLeechCommand = f'nzipleech{CMD_INDEX}'
        self.QbLeechCommand = f'nqbleech{CMD_INDEX}'
        self.QbUnzipLeechCommand = f'nqbunzipleech{CMD_INDEX}'
        self.QbZipLeechCommand = f'nqbzipleech{CMD_INDEX}'
        self.LeechWatchCommand = f'nleechwatch{CMD_INDEX}'
        self.LeechZipWatchCommand = f'nleechzipwatch{CMD_INDEX}'
